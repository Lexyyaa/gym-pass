...
INSERT IGNORE INTO membership (id, member_id, branch_id, type, status, start_date, end_date, total_count, remaining_count, price, created_at, updated_at)
VALUES (1, 1, 1, 'PERIOD', 'ACTIVE', '2026-09-01', '2027-09-01', NULL, NULL, 900000, NOW(6), NOW(6));
-- 2: 회원 2 · 지점 1 · 횟수제 10회(잔여 10) · ACTIVE, 종료일 = 시작일 + 6개월 (D-7) (차감 데모)
INSERT IGNORE INTO membership (id, member_id, branch_id, type, status, start_date, end_date, total_count, remaining_count, price, created_at, updated_at)
VALUES (2, 2, 1, 'COUNT', 'ACTIVE', '2026-09-01', '2027-03-01', 10, 10, 200000, NOW(6), NOW(6));
-- 3: 회원 3 · 지점 1 · 기간제 3개월 · EXPIRED (상태 필터 · 출입 거부 데모)
INSERT IGNORE INTO membership (id, member_id, branch_id, type, status, start_date, end_date, total_count, remaining_count, price, created_at, updated_at)
VALUES (3, 3, 1, 'PERIOD', 'EXPIRED', '2026-01-01', '2026-04-01', NULL, NULL, 300000, NOW(6), NOW(6));
-- 4: 회원 4 · 지점 2 · 기간제 12개월 · ACTIVE (지점 격리 403 데모)
INSERT IGNORE INTO membership (id, member_id, branch_id, type, status, start_date, end_date, total_count, remaining_count, price, created_at, updated_at)
VALUES (4, 4, 2, 'PERIOD', 'ACTIVE', '2026-09-01', '2027-09-01', NULL, NULL, 900000, NOW(6), NOW(6));
